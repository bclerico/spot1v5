...
CREATE TABLE `profile` (
  ...
  UNIQUE KEY `spot_id_idx` (`spot_id`),
  UNIQUE KEY `spot_idx` (`spot_id`,`spot_device_name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `profile` (uid, pwd, email, fname, mi, lname, bc_long, bc_lat, spot_id, spot_device_name, dto) VALUES ('bclerico','password','bclerico@gmail.com','Bill','','Clerico','-74.12097','40.33067','0-8132285','wjclerico','20180404113039');
UNLOCK TABLES;
